...
=for html <a href="https://travis-ci.org/karpet/dezi-app"><img src="https://travis-ci.org/karpet/dezi-app.svg?branch=master"></a>
...
This module uses Dist::Zilla. After `git clone` try:
